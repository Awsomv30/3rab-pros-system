...
client.user.setGame(`+help|3rab_pros`,"http://twitch.tv/Death Shop")
...
if(message.content.startsWith("+daily")) { // الامر والبريفكس
...
if(message.content.startsWith('+trans')) { // الامر حق تحويل مع البريفكس
          if (!args[0]) {
